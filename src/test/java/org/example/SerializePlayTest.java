...
public class SerializePlayTest {
        @Test public void testSerialize() throws IOException, SAXException, IntrospectionException {
            Play play = new Play();
            ...
            String expected = new String(getClass().getClassLoader().getResourceAsStream("play-expected.xml").readAllBytes());
